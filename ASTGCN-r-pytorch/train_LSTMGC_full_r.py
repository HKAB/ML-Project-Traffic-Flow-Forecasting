...
hidden_feat = int(training_config['hidden_feat'])
...
def train_main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if masked_flag:
            val_loss = compute_val_loss_astgcn_full(net, val_loader, criterion_masked, masked_flag,missing_value,sw, epoch)
        else:
            val_loss = compute_val_loss_astgcn_full(net, val_loader, criterion, masked_flag, missing_value, sw, epoch)
...
def predict_main(global_step, data_loader, data_target_tensor,metric_method, _mean, _std, type):
    ...
    predict_and_save_results_astgcn_full(net, data_loader, data_target_tensor, global_step, metric_method,_mean, _std, params_path, type)
